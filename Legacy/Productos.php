                ...
                <a href="#" class="navbar-brand"> <span class="text-primary">osti</span>tos </a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        if($Rol==2){
                            ...
                            <a href='InicioCliente.php' class='nav-link'>Inicio Cliente</a>
                            </li>";
                        }elseif($Rol==1){
                            echo "<li class='nav-item'>
                            <a href='InicioAdmin.php' class='nav-link'>Inicio Administrador</a>
                            </li>";
                        }elseif(!$Rol){
                            echo "
                            <li class='nav-item'>
                            ...
                            <li class='nav-item'>
                                <a href='login.php' class='nav-link'>Inicio de Sesion</a>
                            </li>
                            <li class='nav-item'>
