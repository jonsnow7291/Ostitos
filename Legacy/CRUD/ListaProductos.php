        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="CRUD/ListaUsuariosNueva.php" class="nav-link">Lista de usuarios</a>
                    </li>
                    <li class="nav-item">    
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td class="filas"><br><a class="Enlace" href="CRUD/EditarProducto.php?IdPro=<?php echo $fila['IdPro']?>"><i class="bi bi-pencil-square"></i></a><br>
										<br><a class="Enlace" href="CRUD/EliminarProductos.php?IdPro=<?php echo $fila['IdPro']?>"><i class="bi bi-trash-fill"></i></a><br></td>
					</tr>
					<?php }?>
				</tbody>
			</table>
