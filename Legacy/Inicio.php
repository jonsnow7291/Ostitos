        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto  mb-2 mb-lg-0">
                    <li class="nav-item">    
                        <a href="Productos.php" class="nav-link text-muted">Productos</a>
                    </li>
                    <li class="nav-item">
                    <li class="nav-item">
                        <a href="login.php" class="nav-link text-muted">Inicio de Sesion</a>
                    </li>
                    <li class="nav-item">
                        <a href="registro.php" class="nav-link text-muted">Registrate</a>
                    </li>
            ...
            <div class="carousel-item <?php echo ($Pro == 1) ? 'active' : ''; ?>">
                ...
                <div class="carousel-caption">
                    <h5><?php
                        ...
                        echo "$nombreCarousel";
                        ?></h5>
                    <a href="login.php" class="btn btn-primary mt">Mas informacion</a>
                </div>
            </div>
        <?php } ?>
    </div>
