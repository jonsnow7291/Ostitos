        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">    
                        <a href="Productos.php" class="nav-link text-muted" target="_blank">Productos</a>
                    </li>
                    <li class="nav-item">    
                        <a href="Admin.php" class="nav-link text-muted" >Funciones Admin</a>
                    </li>
                    <li class="nav-item">    
                            <?php if($resultadoUsuario&&$row= mysqli_fetch_assoc($resultadoUsuario)){

                            echo "<a target='_blank' href='Editar.php' class='nav-link text-muted'>Actualiza tus datos</a>";
                            }  ?>
                    </li>
                    <li class="nav-item">    
                        <a href="CerrarSesion.php" class="nav-link text-muted">CerrarSesion</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-muted text-center bg-primary-subtle pb-2">
                        <div class="card-body">
                            ...
                            <a href="registro.php"><button class="btn bg-primary text-white" >Mas informacion</button></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
