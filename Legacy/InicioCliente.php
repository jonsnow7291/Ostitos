            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">    
                            ...
                            echo "<a target='_blank' href='Editar.php?IdUsu=".$row["IdUsu"]."' class='nav-link'>Cliente:".$row['NicknameUsu']."</a>";
                            }  ?>
                    </li>
                    <li class="nav-item">    
                        <a href="CerrarSesion.php" class="nav-link">CerrarSesion</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="card-body">
                            ...
                            <button class="btn bg-primary text-white"  href="login.html">Mas informacion </button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
