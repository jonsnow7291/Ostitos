...
<head>
    ...
    <link rel="stylesheet" href="css/estilosp.css">
                ...
                <?php
                        ...
                        $RutaP = "select * from fichas_productos where Id = 13 ";
            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <?php
                        if($Rol==2){
                            echo "<a href='InicioCliente.php' class='nav-link'>Inicio Cliente</a>";
                        }elseif($Rol==1){
                            echo "<a href='InicioAdmin.php' class='nav-link'>Inicio Admin</a>";
                        }elseif(!$rol){
                            echo "<a href='Inicio.php' class='nav-link'>Inicio Admin</a>";
                        }
                        ?>
                    </li>
                    <li class="nav-item">    
