        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a href="Inicio.php" class="nav-link text-muted">Inicio</a>
                    </li>
                    <li class="nav-item">    
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="CRUD/ListaProductos.php" class="btn btn-primary mt">Administrar</a>
                </div>
            </div>
            <div class="carousel-item">
            <img src="/Adicionales/ImgsAdminInicio/Carousel/Daniel Y Miguel.jpg" class="d-block w-100" alt="">
                <div class="carousel-caption">
                    ...
                    <a href="CRUD/ListaUsuariosNueva.php" class="btn btn-primary mt">Administrar</a>
                </div>
            </div>
        </div>
