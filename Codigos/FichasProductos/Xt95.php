    ...
    <section>
        <div class="col-lg-4 col-md-12 col-12">
            <div class="img-area mb-4">
                <img src="/Adicionales/Productos/Xt95/Imagen principal.jpg" class="img" class="img-fluid" alt="">
            </div>
            <div class="todas-img">
                <div class="">
                    <img src="/Adicionales/Productos/Xt95/Imagen principal.jpg" class="imagenes-pequeñas" alt="">
                </div>
                    <img src="/Adicionales/Productos/Xt95/Imagen principal.jpg" class="img-1" alt="">
                <img src="/Adicionales/Productos/Xt95/Imagen principal.jpg" class="img-2" alt="">
                <img src="/Adicionales/Productos/Xt95/Imagen principal.jpg" class="img-3" alt="">
                
            </div>
        </div>
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
            <div class="text-black" class="text">
                <h2 class="text"> Xt95 pro lenovo <br> lo ultimo en inovacion </h2>
                <p class="text1">
