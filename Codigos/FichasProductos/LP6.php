...
<head>
    ...
    <link rel="stylesheet" href="/Codigos/css/estilosp.css">
                ...
                <?php
                        ...
                        $RutaP = "select * from fichas_productos where Id = 10 ";
