        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarS">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="/Codigos/Empleado.php" class="nav-link text-muted">Funciones Empleado</a>
                    </li>
                    <li class="nav-item">    
                    ...
                    <li class="nav-item">    
                            ...
                            echo "<a target='_blank' href='/Codigos/Editar.php?IdUsu=".$row["IdUsu"]."' class='nav-link  text-muted'>Empleada:".$row['NicknameUsu']."</a>";
                            }  ?>
                    </li>
                    <li class="nav-item">    
